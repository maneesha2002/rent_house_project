          ...
          <form method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="estimated_price">Estimated Price Per Month:</label>
                  ...
                  <tr>
                    ...
                    <form method="POST">
                      <td style="display: flex;">
                        ...
                        <a data-toggle="pill" class="btn btn-success" name="edit_property" href="/renthouse/owner/edit-property.php?property_id=<?php echo $rows['property_id']; ?>" onclick="navigate('/renthouse/owner/edit-property.php?property_id=<?php echo $rows['property_id']; ?>')">
                          Edit</a>
                        <input type=" submit" class="btn btn-danger" name="delete_property" value="Delete" onclick="navigate('/renthouse/owner/delete-property.php?property_id=<?php echo $rows['property_id']; ?>')">
                      </td>
                  </tr>
                  </form>
              <?php }
